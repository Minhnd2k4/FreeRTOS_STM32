...
#define GREEN_LED_MASK		0x0002
#define BLUE_LED_MASK		0x0003
/* USER CODE END PD */
...
static TaskHandle_t recvNotifyTask = NULL;
/* USER CODE END 0 */
...
void sendingTask(void *Notused)
{
	while(1)
	{
		xTaskNotify(recvNotifyTask, RED_LED_MASK, eSetValueWithOverwrite);
		vTaskDelay(200);
	}
}
/* USER CODE END 4 */
